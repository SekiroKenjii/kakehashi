...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/SekiroKenjii/kakehashi/server/internal/gen/kakehashi/notes/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	NotesServiceName = "kakehashi.notes.v1.NotesService"
)
...
const (
	...
	NotesServiceListNotesProcedure = "/kakehashi.notes.v1.NotesService/ListNotes"
	// NotesServiceGetNoteProcedure is the fully-qualified name of the NotesService's GetNote RPC.
	NotesServiceGetNoteProcedure = "/kakehashi.notes.v1.NotesService/GetNote"
	// NotesServiceCreateNoteProcedure is the fully-qualified name of the NotesService's CreateNote RPC.
	NotesServiceCreateNoteProcedure = "/kakehashi.notes.v1.NotesService/CreateNote"
	// NotesServiceUpdateNoteProcedure is the fully-qualified name of the NotesService's UpdateNote RPC.
	NotesServiceUpdateNoteProcedure = "/kakehashi.notes.v1.NotesService/UpdateNote"
	// NotesServiceDeleteNoteProcedure is the fully-qualified name of the NotesService's DeleteNote RPC.
	NotesServiceDeleteNoteProcedure = "/kakehashi.notes.v1.NotesService/DeleteNote"
)

// NotesServiceClient is a client for the kakehashi.notes.v1.NotesService service.
...
// NewNotesServiceClient constructs a client for the kakehashi.notes.v1.NotesService service. By
...
func NewNotesServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NotesServiceClient {
	...
	notesServiceMethods := v1.File_kakehashi_notes_v1_notes_proto.Services().ByName("NotesService").Methods()
...
// ListNotes calls kakehashi.notes.v1.NotesService.ListNotes.
...
// GetNote calls kakehashi.notes.v1.NotesService.GetNote.
...
// CreateNote calls kakehashi.notes.v1.NotesService.CreateNote.
...
// UpdateNote calls kakehashi.notes.v1.NotesService.UpdateNote.
...
// DeleteNote calls kakehashi.notes.v1.NotesService.DeleteNote.
...
// NotesServiceHandler is an implementation of the kakehashi.notes.v1.NotesService service.
...
func NewNotesServiceHandler(svc NotesServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/kakehashi.notes.v1.NotesService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotesServiceHandler) ListNotes(context.Context, *connect.Request[v1.ListNotesRequest]) (*connect.Response[v1.ListNotesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("kakehashi.notes.v1.NotesService.ListNotes is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) GetNote(context.Context, *connect.Request[v1.GetNoteRequest]) (*connect.Response[v1.GetNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("kakehashi.notes.v1.NotesService.GetNote is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) CreateNote(context.Context, *connect.Request[v1.CreateNoteRequest]) (*connect.Response[v1.CreateNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("kakehashi.notes.v1.NotesService.CreateNote is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) UpdateNote(context.Context, *connect.Request[v1.UpdateNoteRequest]) (*connect.Response[v1.UpdateNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("kakehashi.notes.v1.NotesService.UpdateNote is not implemented"))
}
...
func (UnimplementedNotesServiceHandler) DeleteNote(context.Context, *connect.Request[v1.DeleteNoteRequest]) (*connect.Response[v1.DeleteNoteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("kakehashi.notes.v1.NotesService.DeleteNote is not implemented"))
}

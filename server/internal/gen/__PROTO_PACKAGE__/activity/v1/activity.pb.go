...
// 	protoc        (unknown)
// source: __PROTO_PACKAGE__/activity/v1/activity.proto
...
func (x *Entry) Reset() {
	*x = Entry{}
	mi := &file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes[0]
...
func (*Entry) Descriptor() ([]byte, []int) {
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListActivityRequest) Reset() {
	*x = ListActivityRequest{}
	mi := &file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListActivityRequest) Descriptor() ([]byte, []int) {
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP(), []int{1}
}
...
func (x *RecordClientEventRequest) Reset() {
	*x = RecordClientEventRequest{}
	mi := &file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecordClientEventRequest) Descriptor() ([]byte, []int) {
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP(), []int{2}
}
...
func (x *RecordClientEventResponse) Reset() {
	*x = RecordClientEventResponse{}
	mi := &file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecordClientEventResponse) Descriptor() ([]byte, []int) {
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP(), []int{3}
}
...
func (x *KindCount) Reset() {
	*x = KindCount{}
	mi := &file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KindCount) Descriptor() ([]byte, []int) {
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP(), []int{4}
}
...
func (x *CategoryCount) Reset() {
	*x = CategoryCount{}
	mi := &file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CategoryCount) Descriptor() ([]byte, []int) {
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP(), []int{5}
}
...
func (x *ListActivityResponse) Reset() {
	*x = ListActivityResponse{}
	mi := &file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListActivityResponse) Descriptor() ([]byte, []int) {
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP(), []int{6}
}
...
var File____PROTO_PACKAGE___activity_v1_activity_proto protoreflect.FileDescriptor

const file____PROTO_PACKAGE___activity_v1_activity_proto_rawDesc = "" +
	"\n" +
	",__PROTO_PACKAGE__/activity/v1/activity.proto\x12\x1d__PROTO_PACKAGE__.activity.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf6\x01\n" +
	"\x05Entry\x12\x12\n" +
	...
	"\aentries\x18\x01 \x03(\v2$.__PROTO_PACKAGE__.activity.v1.EntryR\aentries\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\x12\x1f\n" +
	"\vtotal_count\x18\x03 \x01(\x05R\n" +
	"totalCount\x12D\n" +
	"\x06counts\x18\x04 \x03(\v2,.__PROTO_PACKAGE__.activity.v1.CategoryCountR\x06counts\x12%\n" +
	"\x0eretention_days\x18\x05 \x01(\x05R\rretentionDays\x12I\n" +
	"\vkind_counts\x18\x06 \x03(\v2(.__PROTO_PACKAGE__.activity.v1.KindCountR\n" +
	"kindCounts2\x93\x02\n" +
	"\x0fActivityService\x12w\n" +
	"\fListActivity\x122.__PROTO_PACKAGE__.activity.v1.ListActivityRequest\x1a3.__PROTO_PACKAGE__.activity.v1.ListActivityResponse\x12\x86\x01\n" +
	"\x11RecordClientEvent\x127.__PROTO_PACKAGE__.activity.v1.RecordClientEventRequest\x1a8.__PROTO_PACKAGE__.activity.v1.RecordClientEventResponseB\x80\x02\n" +
	"!com.__PROTO_PACKAGE__.activity.v1B\rActivityProtoP\x01ZJ__GO_MODULE__/server/internal/gen/__PROTO_PACKAGE__/activity/v1;activityv1\xa2\x02\x03_AX\xaa\x02\x18PROTOPACKAGE.Activity.V1\xca\x02\x18PROTOPACKAGE\\Activity\\V1\xe2\x02$PROTOPACKAGE\\Activity\\V1\\GPBMetadata\xea\x02\x1aPROTOPACKAGE::Activity::V1b\x06proto3"

var (
	file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescOnce sync.Once
	file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescData []byte
)

func file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescGZIP() []byte {
	file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescOnce.Do(func() {
		file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file____PROTO_PACKAGE___activity_v1_activity_proto_rawDesc), len(file____PROTO_PACKAGE___activity_v1_activity_proto_rawDesc)))
	})
	return file____PROTO_PACKAGE___activity_v1_activity_proto_rawDescData
}

var file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file____PROTO_PACKAGE___activity_v1_activity_proto_goTypes = []any{
	(*Entry)(nil),                     // 0: __PROTO_PACKAGE__.activity.v1.Entry
	(*ListActivityRequest)(nil),       // 1: __PROTO_PACKAGE__.activity.v1.ListActivityRequest
	(*RecordClientEventRequest)(nil),  // 2: __PROTO_PACKAGE__.activity.v1.RecordClientEventRequest
	(*RecordClientEventResponse)(nil), // 3: __PROTO_PACKAGE__.activity.v1.RecordClientEventResponse
	(*KindCount)(nil),                 // 4: __PROTO_PACKAGE__.activity.v1.KindCount
	(*CategoryCount)(nil),             // 5: __PROTO_PACKAGE__.activity.v1.CategoryCount
	(*ListActivityResponse)(nil),      // 6: __PROTO_PACKAGE__.activity.v1.ListActivityResponse
	(*timestamppb.Timestamp)(nil),     // 7: google.protobuf.Timestamp
}
var file____PROTO_PACKAGE___activity_v1_activity_proto_depIdxs = []int32{
	7, // 0: __PROTO_PACKAGE__.activity.v1.Entry.occurred_at:type_name -> google.protobuf.Timestamp
	7, // 1: __PROTO_PACKAGE__.activity.v1.ListActivityRequest.from:type_name -> google.protobuf.Timestamp
	7, // 2: __PROTO_PACKAGE__.activity.v1.ListActivityRequest.to:type_name -> google.protobuf.Timestamp
	0, // 3: __PROTO_PACKAGE__.activity.v1.ListActivityResponse.entries:type_name -> __PROTO_PACKAGE__.activity.v1.Entry
	5, // 4: __PROTO_PACKAGE__.activity.v1.ListActivityResponse.counts:type_name -> __PROTO_PACKAGE__.activity.v1.CategoryCount
	4, // 5: __PROTO_PACKAGE__.activity.v1.ListActivityResponse.kind_counts:type_name -> __PROTO_PACKAGE__.activity.v1.KindCount
	1, // 6: __PROTO_PACKAGE__.activity.v1.ActivityService.ListActivity:input_type -> __PROTO_PACKAGE__.activity.v1.ListActivityRequest
	2, // 7: __PROTO_PACKAGE__.activity.v1.ActivityService.RecordClientEvent:input_type -> __PROTO_PACKAGE__.activity.v1.RecordClientEventRequest
	6, // 8: __PROTO_PACKAGE__.activity.v1.ActivityService.ListActivity:output_type -> __PROTO_PACKAGE__.activity.v1.ListActivityResponse
	3, // 9: __PROTO_PACKAGE__.activity.v1.ActivityService.RecordClientEvent:output_type -> __PROTO_PACKAGE__.activity.v1.RecordClientEventResponse
...
func init() { file____PROTO_PACKAGE___activity_v1_activity_proto_init() }
func file____PROTO_PACKAGE___activity_v1_activity_proto_init() {
	if File____PROTO_PACKAGE___activity_v1_activity_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file____PROTO_PACKAGE___activity_v1_activity_proto_rawDesc), len(file____PROTO_PACKAGE___activity_v1_activity_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file____PROTO_PACKAGE___activity_v1_activity_proto_goTypes,
		DependencyIndexes: file____PROTO_PACKAGE___activity_v1_activity_proto_depIdxs,
		MessageInfos:      file____PROTO_PACKAGE___activity_v1_activity_proto_msgTypes,
	}.Build()
	File____PROTO_PACKAGE___activity_v1_activity_proto = out.File
	file____PROTO_PACKAGE___activity_v1_activity_proto_goTypes = nil
	file____PROTO_PACKAGE___activity_v1_activity_proto_depIdxs = nil
}

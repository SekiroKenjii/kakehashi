...
namespace Kakehashi.App.Services.Platform {
  // The theme has to reach the title-bar caption buttons as well as the content root; it is stored
  // via ILocalSettingsService because the unpackaged app has no ApplicationData.

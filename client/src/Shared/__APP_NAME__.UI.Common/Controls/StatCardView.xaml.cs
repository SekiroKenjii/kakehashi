...
/// <remarks>
/// A <c>UserControl</c> in <c>__ROOT_NAMESPACE__.UI.Common</c> rather than a shared <c>DataTemplate</c>,
...
public sealed partial class StatCardView : UserControl
{
    ...
    public static Brush BrushFor(StatCard? card)
    {
        return card?.Kind switch {
            ...
            // Fully qualified: a bare Application can bind to a __ROOT_NAMESPACE__.Application namespace rather

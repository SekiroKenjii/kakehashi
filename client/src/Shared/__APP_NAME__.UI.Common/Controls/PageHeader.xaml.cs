...
/// XAML content) on the right. Lives in <c>__ROOT_NAMESPACE__.UI.Common</c> so feature modules can
...
public sealed partial class PageHeader : UserControl
{
    ...
    public static readonly DependencyProperty RootProperty = DependencyProperty.Register(
        nameof(Root), typeof(string), typeof(PageHeader), new PropertyMetadata("__APP_TITLE__"));

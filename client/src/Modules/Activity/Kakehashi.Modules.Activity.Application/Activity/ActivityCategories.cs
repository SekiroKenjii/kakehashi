namespace Kakehashi.Modules.Activity.Application.Activity {
  ...
  //
  // All is this client's own idea. The server has no such category; an empty category
  // means "do not narrow", and the chip that says so needs a value to hold.
  public static class ActivityCategories {
    // Every category. Not a server value — the wire carries an empty string for this.
    public const string All = "";

    // Sessions beginning and ending.
    public const string SignIn = "SignIn";

    // Refused attempts, password changes, somebody else ending a session.

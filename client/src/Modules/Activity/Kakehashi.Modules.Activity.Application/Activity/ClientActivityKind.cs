namespace Kakehashi.Modules.Activity.Application.Activity {
  ...
  //
  // It is the module's own type rather than the host's AppActivityKind because this layer may
  ...
  public enum ClientActivityKind {
    // This installation is running a newer build than it was.
    AppUpdated,

    // The chosen theme changed.
    ThemeChanged,
  }
}

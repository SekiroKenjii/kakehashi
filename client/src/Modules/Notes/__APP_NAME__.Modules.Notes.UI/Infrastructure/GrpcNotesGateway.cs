...
namespace __ROOT_NAMESPACE__.Modules.Notes.UI.Infrastructure;
...
/// </summary>
/// <remarks>
/// The alias is <c>NotesV1</c> rather than <c>Notes</c> because inside a <c>__ROOT_NAMESPACE__.*</c>
/// namespace the identifier <c>Notes</c> binds to the enclosing <c>__ROOT_NAMESPACE__.Modules.Notes</c>

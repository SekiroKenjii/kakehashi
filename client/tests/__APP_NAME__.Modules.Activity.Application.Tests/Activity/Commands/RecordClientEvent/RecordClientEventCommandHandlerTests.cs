...
using __ROOT_NAMESPACE__.Modules.Activity.Application.Activity.Commands.RecordClientEvent;
using __ROOT_NAMESPACE__.SharedKernel;
using NSubstitute;
using Xunit;

namespace __ROOT_NAMESPACE__.Modules.Activity.Application.Tests.Activity.Commands.RecordClientEvent;

...
using __ROOT_NAMESPACE__.Modules.Activity.Application.Activity.Queries.GetActivity;
...
namespace __ROOT_NAMESPACE__.Modules.Activity.UI.Tests.ViewModels;
...
public sealed class ActivityViewModelTests
{
        ...
        string id = "id")
    {
        return new ActivityEntryDto(
            id, kind, ActivityCategories.SignIn, session, "__APP_NAME__/1 (Windows NT 10.0)", platform,
            "10.0.0.1", at);
    }
